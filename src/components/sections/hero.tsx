...
export const Hero = () => {
  ...
  const bannerImage = useLanguageImage("banner");

  const handleAnchor = (id: string) => (event: MouseEvent) => {
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative hidden md:block lg:mt-0">
            <div className="absolute -top-10 -left-10 w-40 h-40 bg-primary/5 rounded-full filter blur-2xl" aria-hidden="true" />
            <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-primary/5 rounded-full filter blur-2xl" aria-hidden="true" />
